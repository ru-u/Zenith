...
export function FavoriteStar({
  ...
  return (
    <button
      ...
      title={label}
      className={cn(
        "shrink-0 rounded-md p-0.5 transition-[color,transform,opacity] duration-200 hover:scale-110 hover:text-brand focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/50 active:scale-90",
        ...
        // Hidden at rest; revealed on row/card hover or keyboard focus. A
        // favorited star ignores this and stays visible so the pinned block is
        // scannable. Opacity (not display) keeps the ticker column aligned.
        revealOnHover &&
          !favorited &&
