...
export default function PrivacyPage() {
  return (
    ...
    >
      ...
      <LegalSection title="Market data and AI analysis">
        <p>
        ...
        <p>
          The daily short theses are generated by our own analysis engine from
          public market data. No personal data about you is sent to any AI
          provider.
        </p>
      </LegalSection>
